# Agora vou criar scripts de inserção de dados mestres
insert_script = """
-- ============================================================================
...
# Continuar com o script de inserção
insert_script2 = """
...
# Salvar o script de inserção
with open('dados_iniciais_indicadores_aps.sql', 'w', encoding='utf-8') as f:
    f.write(insert_script + insert_script2)

print("Script de dados iniciais criado: dados_iniciais_indicadores_aps.sql")
print("Dados inseridos:")
print("- 5 regiões do Brasil")
print("- 4 categorias de indicadores")
print("- 6 tipos de equipes")
print("- 35 CBOs principais")
print("- 45 procedimentos SIGTAP")
print("- 47 condições de saúde (CID-10 e CIAP-2)")
print("- 19 vacinas do calendário nacional")
print("- 15 indicadores principais")